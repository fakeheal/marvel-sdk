 ...
 * getComicsCollection
 *
 * Fetches lists of comics which take place during a specific event, with optional filters. See notes
 * on individual parameters below.
 */
class GetEventComics extends Request
{
    ...
    {
        return "/events/$this->eventId/comics";
    }
