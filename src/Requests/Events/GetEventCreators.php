 ...
 *
 * Fetches lists of comic creators whose work appears in a specific event, with optional filters. See
 * notes on individual parameters below.
 */
class GetEventCreators extends Request
{
    ...
    {
        return "/events/$this->eventId/creators";
    }
