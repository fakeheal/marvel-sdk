 ...
 * getComicsCollection
 *
 * Fetches lists of comics in which a specific story appears, with optional filters. See notes on
 * individual parameters below.
 */
class GetStoryComics extends Request
{
    ...
    {
        return "/stories/$this->storyId/comics";
    }
