 ...
 *
 * Fetches lists of comic series in which a specific creator's work appears, with optional filters. See
 * notes on individual parameters below.
 */
class GetCreatorSeries extends Request
{
    ...
    {
        return "/creators/$this->creatorId/series";
    }
