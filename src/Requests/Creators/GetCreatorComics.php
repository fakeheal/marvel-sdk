 ...
 * getComicsCollection
 *
 * Fetches lists of comics in which the work of a specific creator appears, with optional filters. See
 * notes on individual parameters below.
 */
class GetCreatorComics extends Request
{
    ...
    {
        return "/creators/$this->creatorId/comics";
    }
